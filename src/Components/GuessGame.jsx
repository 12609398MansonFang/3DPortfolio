...
import img1 from '../Assets/Images/1 Steps.png';
import img2 from '../Assets/Images/2 Steps.png';
import img3 from '../Assets/Images/3 Steps.png';
import img4 from '../Assets/Images/4 Steps.png';
import img5 from '../Assets/Images/5 Steps.png';
import img6 from '../Assets/Images/Game Over.png';
import content from '../Assets/JSON/Game.json';
    ...
    return (
        <div className='Container min-w-80 max-w-96 bg-transparent flex flex-col'>
            <div className='GameTab p-1 rounded-t-md bg-slate-300'>        
                <h1 className='GameTabMessage flex item-center justify-center text-sm'>Have Fun</h1>
            </div>
